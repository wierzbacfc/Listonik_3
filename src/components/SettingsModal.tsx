              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 pb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <button
                      onClick={() => { setGeminiApiKey(apiKeyInput.trim()); handleTestKey(); }}
                      className="px-4 bg-primary-500 hover:bg-primary-600 text-white rounded-xl text-sm font-medium transition-colors shrink-0"
                    >
                      Zapisz klucz
                    </button>
                  </div>
                  <div className="p-4 rounded-2xl border bg-zinc-50/50 dark:bg-zinc-800/30 border-zinc-200 dark:border-zinc-800 flex flex-col gap-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5 max-w-[200px]">
                            {isTestLoading ? "Weryfikacja klucza wymaganego do kategoryzacji produktów." : 
                             ...
                             "Sprawdź klucz API lub połączenie z internetem."}
                          </p>
                        </div>
                      </div>
                      <button
