    ...
    <div className="relative w-full">
          ...
          >
            {suggestions.map((item, idx) => (
              <button
                ...
                className="text-left px-4 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-800 border-b border-zinc-100 dark:border-zinc-800/50 last:border-0 transition-colors flex items-center justify-between"
              >
      ...
      <div className="flex items-center gap-2 p-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-full shadow-lg">
        ...
        <button
          ...
          className="w-10 h-10 shrink-0 rounded-full bg-emerald-500 hover:bg-emerald-600 disabled:bg-zinc-200 dark:disabled:bg-zinc-800 text-white flex items-center justify-center transition-colors shadow-md"
        >
          {isClassifying ? (
